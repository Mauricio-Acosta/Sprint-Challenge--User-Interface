...
Semantic HTML is HTML that is easily readable for the next developer and is easily read by screen readers for people with disabilties.
...
It allows a team to easily manipulate code and access early versions of code

5. Define mobile-first design in your own words.
Mobile-first is when you desing a page specifically for mobile and then scale it up to desktop
